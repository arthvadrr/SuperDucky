    ...
    <g clip-path="url(#_clip1)">
      <g id="Feet">
        <path
          ...
          style="fill: #f58d2a; stroke-width: 2px"
          stroke="#000"
        />
        <path
          id="Right-Foot"
      ...
      <g id="HeadGroup" :class="{ walkingHead: isWalking }">
        <path
          id="Head"
...
.idleEye {
  animation: eyeIdle 5s infinite;
  transform-origin: center;
}

.walkingHead {
  animation: headBob 200ms infinite;
  transform-origin: center;
}
