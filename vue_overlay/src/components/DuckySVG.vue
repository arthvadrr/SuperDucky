  ...
  >
    <g>
      ...
      >
        ...
        <g data-section="Eyebrows">
          <path
            data-section="Left-Eyebrow"
            d="M34,22l3.5,-0.5"
            stroke-width="2px"
            stroke="#000"
            fill="none"
